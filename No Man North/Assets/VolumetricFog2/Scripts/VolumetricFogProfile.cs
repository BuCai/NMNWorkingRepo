...
namespace VolumetricFogAndMist2 {
    ...
    public class VolumetricFogProfile : ScriptableObject {
        ...
        public void Lerp(VolumetricFogProfile p1, VolumetricFogProfile p2, float t) {
            ...
            depthGradient = Util.Gradient.Lerp(p1.depthGradient, p2.depthGradient, t);
            depthGradientTex = t < 0.5f ? p1.depthGradientTex : p2.depthGradientTex;
            ...
            heightGradient = Util.Gradient.Lerp(p1.heightGradient, p2.heightGradient, t);
            heightGradientTex = t < 0.5f ? p1.heightGradientTex : p2.heightGradientTex;
