...
public class GrassMeshGenerator : MonoBehaviour {
    ...
    [BoxGroup("LOD: 0"), ExternalPropertyAttributes.Label("Options")] public LODTopologyOptions lod0;

    [BoxGroup("LOD: 1"), ExternalPropertyAttributes.Label("Enabled")] public bool enableLod1 = true;

    [ExternalPropertyAttributes.ShowIf(nameof(enableLod1)), BoxGroup("LOD: 1"), ExternalPropertyAttributes.Label("Options")]
    public LODTopologyOptions lod1;

    [BoxGroup("LOD: 2"), ExternalPropertyAttributes.Label("Enabled")] public bool enableLod2 = false;

    [ExternalPropertyAttributes.ShowIf(nameof(enableLod2)), BoxGroup("LOD: 2"), ExternalPropertyAttributes.Label("Options")]
