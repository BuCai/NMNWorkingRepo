...
public class FoliageGenerator : MonoBehaviour {
    ...
    [BoxGroup("Generation"), ExternalPropertyAttributes.Label("Particles"), Space]
    [Tooltip("The number of particles to generate.")]
    public int numParticles = 250;

    [BoxGroup("Generation"), ExternalPropertyAttributes.Label("Placement type"), Space]
    ...
    [ExternalPropertyAttributes.Label("    Fraction Of Particles")]
    ...
    [BoxGroup("Billboard whole object"), ExternalPropertyAttributes.EnableIf(nameof(EnableBiasTowardRotation))]
    ...
    [ExternalPropertyAttributes.Label("Enable")]
    public bool noiseEnabled = false;

    [ExternalPropertyAttributes.EnableIf(nameof(noiseEnabled)), BoxGroup("Normal Noise")]
    [ExternalPropertyAttributes.Label("Frequency")]
    public float noiseFrequency = 1f;

    [ExternalPropertyAttributes.EnableIf(nameof(noiseEnabled)), BoxGroup("Normal Noise")]
    [ExternalPropertyAttributes.Label("Amplitude")]
    public float noiseAmplitude = 1f;

    [ExternalPropertyAttributes.EnableIf(nameof(noiseEnabled)), BoxGroup("Normal Noise")]
    [ExternalPropertyAttributes.Label("Octaves"), Range(1, 5)]
    public uint noiseOctaves = 1;

    [ExternalPropertyAttributes.EnableIf(nameof(noiseEnabled)), BoxGroup("Normal Noise")]
    [ExternalPropertyAttributes.Label("Scale")]
    public Vector3 noiseScale = Vector3.one;

    [ExternalPropertyAttributes.EnableIf(nameof(noiseEnabled)), BoxGroup("Normal Noise")]
    [ExternalPropertyAttributes.Label("Seed")]
    ...
    [BoxGroup("Export")]
    [ExternalPropertyAttributes.ShowIf(nameof(appendTakeNumber)), ExternalPropertyAttributes.Label("    Take Number")]
