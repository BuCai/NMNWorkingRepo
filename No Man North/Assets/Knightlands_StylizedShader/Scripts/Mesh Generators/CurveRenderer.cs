...
public class CurveRenderer : MonoBehaviour {
    ...
    [ExternalPropertyAttributes.EnableIf(nameof(IsMultipleWires)), BoxGroup("Multiple Curves")]
    public float curveVariability = 0.2f;

    [ExternalPropertyAttributes.EnableIf(nameof(IsMultipleWires)), BoxGroup("Multiple Curves")] [Range(0, 1)]
    ...
    [Foldout("Advanced"), ExternalPropertyAttributes.Label("UV")]
