...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public override void Enable()
        {
            ...
            if(blackTex == null)
               blackTex = Resources.Load("tex_enviro_black") as Texture2D;
        }
        ...
        { 
            ...
            //Somehow this texture might get lost in runtime. Make sure to load it in this case.
            if(blackTex == null)
               blackTex = Resources.Load("tex_enviro_black") as Texture2D;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public void RenderVolumetrics(Camera camera, RenderTexture source)
        {
            ...
            {       
                Shader.SetGlobalTexture("_EnviroVolumetricFogTex", blackTex); 
                return;
            }
