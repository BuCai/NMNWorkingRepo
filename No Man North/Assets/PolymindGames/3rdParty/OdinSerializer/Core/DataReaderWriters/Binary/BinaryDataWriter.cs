...
namespace SurvivalTemplatePro.OdinSerializer
{
    using SurvivalTemplatePro.OdinSerializer.Utilities;
    using SurvivalTemplatePro.OdinSerializer.Utilities.Unsafe;
    using System;
