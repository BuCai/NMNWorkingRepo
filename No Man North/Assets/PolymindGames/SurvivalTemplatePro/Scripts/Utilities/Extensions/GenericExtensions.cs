...
namespace SurvivalTemplatePro
{
    public static class GenericExtensions
	{
		...
		public static bool IsPartOfArray(this int refInt, int[] range)
		{
		...
		public static int GetSmallestValue(this int[] intArray)
		{
		...
		public static int GetLargestValue(this int[] intArray)
		{
		...
		public static Vector3 GetNaNSafeVector(this Vector3 vector) 
		{
		...
		public static T DequeueAs<T>(this Queue<object> queue)
		{
