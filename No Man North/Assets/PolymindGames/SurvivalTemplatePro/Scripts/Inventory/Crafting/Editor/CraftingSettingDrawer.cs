...
namespace SurvivalTemplatePro.InventorySystem
{
    ...
    public class CraftingSettingDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (hasBlueprintProp.boolValue)
            {
                ...
                SerializedProperty craftLevelProp = property.FindPropertyRelative("m_CraftLevel");
                ...
                EditorGUI.PropertyField(rect, craftLevelProp);
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            return hasBlueprintProp.boolValue ? EditorGUI.GetPropertyHeight(property, true) : EditorGUIUtility.singleLineHeight + kPadding * 2;
        }
    }
}