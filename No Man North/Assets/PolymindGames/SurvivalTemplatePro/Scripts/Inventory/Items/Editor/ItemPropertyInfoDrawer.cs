	...
	public class ItemPropertyInfoDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			if (m_Properties != null && m_Properties.Length > 0)
			{
				...
				EditorGUI.LabelField(descriptionRect, "Type: " + propType.ToString().ToUnityLikeNameFormat(), EditorStyles.miniLabel);
				...
				{
					bool boolean = !Mathf.Approximately(valueProp.floatValue, 0f);
				...
				else if (propType == ItemPropertyType.Item || propType == ItemPropertyType.Attachment)
				{
