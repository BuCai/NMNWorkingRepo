...
namespace SurvivalTemplatePro
{
	...
	public struct ItemPropertyReference
	{
		...
		public InventorySystem.ItemPropertyDefinition GetProperty() => ItemDatabase.GetPropertyById(m_Value);

		public override string ToString() => ItemDatabase.GetPropertyById(m_Value).Name;
