...
{
    public class ItemManagementWindow : AssetDatabaseWindow<ItemDatabase>
	{
        ...
        protected override void DrawDatabaseEditor()
        {
		...
		protected override int GetDatabaseInstanceCount() => ItemDatabase.GetInstanceCount();

        protected override void InitializeDatabaseEditor(ItemDatabase itemDatabase)
        {
			if (itemDatabase != null)
			{
				m_ItemDatabase = new SerializedObject(itemDatabase);
