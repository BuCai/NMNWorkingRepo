...
namespace SurvivalTemplatePro {
    ...
    public class HealthManager : CharacterBehaviour, IHealthManager, ISaveableComponent {
        ...
        [SerializeField] private bool preventDamageWhileSleeping = true;
        ...
        [HideInInspector] public float temperatureRegenMultiplier = 1f;
        ...
        public virtual void RestoreHealth(float healthRestore) {
            healthRestore *= temperatureRegenMultiplier;
        ...
        public virtual void ReceiveDamage(DamageInfo damageInfo) {
            //Prevent taking damage when sleeping
            if (preventDamageWhileSleeping && STPGameStateManager.Instance.gameState == GameState.Sleeping) {
                return;
            }
