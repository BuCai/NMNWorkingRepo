...
namespace SurvivalTemplatePro
{
    ...
    public class PlayerLookHandler : CharacterBehaviour, ILookHandler, ISaveableComponent
    {
        ...
        public void SetLookInput(LookInputCallback lookInputCallback) => m_LookInputCallback = lookInputCallback;
        ...
        public override void OnInitialized()
        {
            ...
            GetModule<ICharacterMotor>().onTeleport += OnTeleport;
        }

        private void OnTeleport()
        {
            m_ViewAngle.y = m_YTransform.localEulerAngles.y;
            m_ViewAngle.x = 0f;
        }
        ...
        private void LateUpdate()
        {
            ...
            if (m_LookInputCallback != null)
                m_CurrentInput = m_LookInputCallback();

            m_CurrentSensitivity = GetTargetSensitivity(m_CurrentSensitivity, deltaTime * 8f);
