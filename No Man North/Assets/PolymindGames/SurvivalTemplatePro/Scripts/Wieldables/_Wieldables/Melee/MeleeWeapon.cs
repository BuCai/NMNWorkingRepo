...
namespace SurvivalTemplatePro.WieldableSystem
{
    ...
    [AddComponentMenu("Wieldables/Melee/Melee Weapon")]
    public class MeleeWeapon : Wieldable, IUseHandler, IStaminaDepleter
    {
        #region Internal
        [System.Serializable]
        protected class SwingCombo
        {
#if UNITY_EDITOR
            ...
            [ReorderableList(ListStyle.Lined, elementLabel: "Swing")]
        ...
        [Title("Melee Settings")]

        [SerializeField]
        protected bool m_SwingContinuosly = true;

        [SpaceArea]

        [SerializeField, ReorderableList(elementLabel:"Combo")]
        protected SwingCombo[] m_Swings;
