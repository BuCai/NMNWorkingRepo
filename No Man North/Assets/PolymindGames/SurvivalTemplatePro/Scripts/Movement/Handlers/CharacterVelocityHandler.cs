...
{
    [HelpURL("https://polymindgames.gitbook.io/welcome-to-gitbook/qgUktTCVlUDA7CAODZfe/player/modules-and-behaviours/movement#character-velocity-handler-behaviour")]
    public class CharacterVelocityHandler : CharacterBehaviour
    {
        ...
        private void SetVelocityMod() 
        {
            ...
            m_Motion.VelocityMod = velocityMod;
        }
