    ...
    public class SurfaceManagementWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            if (m_Surfaces != null)
            {
                ...
                m_CachedSurfaceInspector.OnInspectorGUI();
        ...
        private void LoadSurfaceAssets()
        {
            ...
            if (surfGUIDs.Length > 0)
            {
                ...
                for (int i = 0;i < surfGUIDs.Length;i++)
                {
                    ...
                    m_SurfaceNames[i] = m_Surfaces[i].name.ToUnityLikeNameFormat();
                }
            }
        }
        ...
        {
            Editor.CreateCachedEditor(m_Surfaces[m_SelectedSurface], null, ref m_CachedSurfaceInspector);
        }
    }
}