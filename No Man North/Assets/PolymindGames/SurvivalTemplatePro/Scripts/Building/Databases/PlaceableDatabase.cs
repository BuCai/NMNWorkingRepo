...
namespace SurvivalTemplatePro
{
    ...
    public class PlaceableDatabase : AssetDatabase<PlaceableDatabase>
	{
        ...
        private int m_BuildableMask;

        [SerializeField, Layer]
        private int m_BuildablePreviewMask;
        ...
        public static LayerMask GetCharacterMask() => Instance != null ? Instance.m_EntityMask : (LayerMask)0;
        public static int GetBuildableMask() => Instance != null ? Instance.m_BuildableMask : 0;
        public static int GetBuildablePreviewMask() => Instance != null ? Instance.m_BuildablePreviewMask : 0;
        #endregion
    }
}