...
namespace SurvivalTemplatePro.BuildingSystem {
    ...
    public class Campfire : Interactable, IExternalContainer, ISaveableComponent {
        ...
        private void Start() {
            ...
            m_TemperatureEffector.maxTemperatureOffset = m_MaxProximityTemperature;
        }
        ...
        public void LoadMembers(object[] members) {
            ...
            m_FireDurationRealtime = (float)members[1];
            FireActive = (bool)members[2];
        }
