...
namespace SurvivalTemplatePro
{
    ...
    public class AudioPlayer : CharacterBehaviour, IAudioPlayer
    {
        #region Internal
        ...
        public void StopLoopingSound(ISound sound, float stopTime = 0.5f)
        {
            if (sound == null)
                return;
            ...
            for (int i = 0; i < m_LoopingQueuedSounds.Count; i++)
            {
                if (m_LoopingQueuedSounds[i].Sound == sound)
                    m_LoopingQueuedSounds[i].StopTime = Time.time + stopTime;
            }
        }
        ...
        public void StopAllLoopingSounds()
        {
            ...
            for (int i = 0; i < m_LoopingQueuedSounds.Count; i++)
                m_LoopingQueuedSounds[i].StopTime = stopTime;
        }
        ...
        public override void OnInitialized()
        {
            ...
            Character.HealthManager.onDeath += StopAllLoopingSounds;
        }
