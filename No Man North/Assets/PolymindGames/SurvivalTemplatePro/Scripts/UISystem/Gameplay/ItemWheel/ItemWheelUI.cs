...
namespace SurvivalTemplatePro.UISystem
{
    public class ItemWheelUI : PlayerUIBehaviour, IItemWheelUI
    {
        ...
        [SerializeField]
        private Vector2 m_OffsetWhenAssigning;

        [SerializeField]
        private Vector2 m_OffsetWhenSelecting;
        ...
        private ItemWheelState m_ItemWheelState = ItemWheelState.None;
        ...
        private readonly Dictionary<WheelSlotUI, IItemSlot> m_SlotDictionary = new Dictionary<WheelSlotUI, IItemSlot>();
                    ...
                    case ItemWheelState.InsertItems:
                        {
                            ...
                            GetComponent<RectTransform>().anchoredPosition = m_OffsetWhenAssigning;
        ...
        public override void OnAttachment()
        {
            ...
            GetComponent<RectTransform>().anchoredPosition = m_OffsetWhenSelecting;
            IItemContainer container = PlayerInventory.GetContainerWithName(m_ContainerName);
        ...
        private void ShowSlotInfo(WheelSlotUI slot)
        {
            if (m_SlotDictionary.TryGetValue(slot, out IItemSlot itemSlot))
            {
