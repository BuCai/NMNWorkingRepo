...
{
    [HelpURL("https://polymindgames.gitbook.io/welcome-to-gitbook/qgUktTCVlUDA7CAODZfe/user-interface/behaviours/ui_inventory#item-auto-mover")]
    public class ItemAutoMover : PlayerUIBehaviour
    {
        [SerializeField, ReorderableList(elementLabel: "Tag")]
        ...
        public void TryAutoMove(ItemSlotUI itemSlotUI)
        {
			...
			IItemSlot slot = itemSlotUI.ItemSlot;
			IItemContainer container = itemSlotUI.Parent.ItemContainer;
        ...
        private bool IsClothing(IItemSlot slot)
		{
        ...
        private bool IsWieldable(IItemSlot slot)
        {
            ItemInfo info = slot.Item.Info;
