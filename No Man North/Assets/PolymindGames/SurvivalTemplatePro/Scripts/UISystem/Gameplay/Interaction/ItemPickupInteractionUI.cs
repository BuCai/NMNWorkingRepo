...
namespace SurvivalTemplatePro.UISystem
{
    ...
    {
        public Type[] InteractableTypes => m_InteractableTypes;
        private static readonly Type[] m_InteractableTypes = new Type[] { typeof(ItemPickup), typeof(ItemPickupWithAttachments) };
