...
namespace SurvivalTemplatePro.UISystem
{
    public class CampfireUI : PlayerUIBehaviour, IObjectInspector
    {
        ...
        private void QueueFireStart()
        {
            ...
            {
                m_LastFuelItemId = m_FuelSelector.SelectedFuel.Id;
                bool removedItemFromStorage = PlayerInventory.RemoveItems(m_LastFuelItemId, 1, ItemContainerFlags.Storage) > 0;
        ...
        private void CancelFireQueue()
        {
            ...
            if (m_LastFuelItemId != -1)
                PlayerInventory.AddItems(m_LastFuelItemId, 1, ItemContainerFlags.Storage);
        }
