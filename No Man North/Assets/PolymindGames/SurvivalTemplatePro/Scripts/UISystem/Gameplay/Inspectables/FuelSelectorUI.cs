...
namespace SurvivalTemplatePro.UISystem
{
    public class FuelSelectorUI : PlayerUIBehaviour
    {
        ...
        public void AttachToInventory(IInventory inventory) 
        {
            ...
            OnInventoryChanged(null, ItemSlotChangeType.ItemChanged);
        }
        ...
        private void OnInventoryChanged(IItemSlot slot, ItemSlotChangeType changeType)
        {
        ...
        private void RefreshFuelList()
        {
            ...
            for (int i = 0; i < PlayerInventory.Containers.Count; i++)
            {
                ...
                {
                    IItem item = PlayerInventory.Containers[i].Slots[j].Item;
