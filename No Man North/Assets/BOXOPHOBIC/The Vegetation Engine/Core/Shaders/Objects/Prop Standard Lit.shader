	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 staticSwitch3466_g60054 = lerpResult1545_g60054;
				#endif
				float2 vertexToFrag11_g62089 = ( ( staticSwitch3466_g60054 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord8.zw = vertexToFrag11_g62089;
				half Mesh_DetailMask90_g60054 = v.ase_color.b;
				float vertexToFrag11_g62105 = ( ( Mesh_DetailMask90_g60054 - 0.5 ) + _DetailMeshValue );
				...
				float lerpResult4755_g60054 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g60054;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half2 Main_UVs15_g60054 = vertexToFrag11_g62084;
				...
				half2 Second_UVs17_g60054 = vertexToFrag11_g62089;
				...
				float temp_output_3919_0_g60054 = vertexToFrag11_g62105;
				...
				half Mask_Detail147_g60054 = saturate( ( ( saturate( ( Blend_Source1540_g60054 + ( Blend_Source1540_g60054 * lerpResult4058_g60054 ) ) ) - temp_output_7_0_g62150 ) / ( _DetailBlendMaxValue - temp_output_7_0_g62150 ) ) );
				float3 lerpResult235_g60054 = lerp( Main_Albedo99_g60054 , ( Main_Albedo99_g60054 * Second_Albedo153_g60054 * staticSwitch1_g62071 ) , Mask_Detail147_g60054);
				float3 lerpResult208_g60054 = lerp( Main_Albedo99_g60054 , Second_Albedo153_g60054 , Mask_Detail147_g60054);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4062_g60054 = lerpResult235_g60054;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4062_g60054 = lerpResult208_g60054;
				#else
				float3 staticSwitch4062_g60054 = lerpResult235_g60054;
				#endif
				...
				float3 staticSwitch255_g60054 = staticSwitch4062_g60054;
				#else
				float3 staticSwitch255_g60054 = Main_Albedo99_g60054;
				#endif
				...
				float3 Position82_g62109 = WorldPosition3905_g60054;
				...
				half Global_Extras_Overlay156_g60054 = break89_g62109.b;
				...
				half Overlay_Mask269_g60054 = saturate( ( ( ( ( ( lerpResult3567_g60054 * 0.5 ) + staticSwitch3574_g60054 ) * Overlay_Commons1365_g60054 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				...
				float3 lerpResult230_g60054 = lerp( float3( 0,0,1 ) , Second_Normal179_g60054 , Mask_Detail147_g60054);
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4063_g60054 = BlendNormal( Main_Normal137_g60054 , lerpResult230_g60054 );
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4063_g60054 = lerpResult3376_g60054;
				#else
				float3 staticSwitch4063_g60054 = BlendNormal( Main_Normal137_g60054 , lerpResult230_g60054 );
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch267_g60054 = staticSwitch4063_g60054;
				#else
				float3 staticSwitch267_g60054 = Main_Normal137_g60054;
				#endif
				float3 temp_output_13_0_g62074 = staticSwitch267_g60054;
				float3 switchResult12_g62074 = (((ase_vface>0)?(temp_output_13_0_g62074):(( temp_output_13_0_g62074 * _render_normals_options ))));
				half3 Blend_Normal312_g60054 = switchResult12_g62074;
				...
				half2 Emissive_UVs2468_g60054 = vertexToFrag11_g62119;
				half Global_Extras_Emissive4203_g60054 = break89_g62109.r;
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4064_g60054 = Main_Metallic237_g60054;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4064_g60054 = lerpResult278_g60054;
				#else
				float staticSwitch4064_g60054 = Main_Metallic237_g60054;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch299_g60054 = staticSwitch4064_g60054;
				#else
				float staticSwitch299_g60054 = Main_Metallic237_g60054;
				#endif
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4065_g60054 = Main_Smoothness227_g60054;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4065_g60054 = lerpResult266_g60054;
				#else
				float staticSwitch4065_g60054 = Main_Smoothness227_g60054;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch297_g60054 = staticSwitch4065_g60054;
				#else
				float staticSwitch297_g60054 = Main_Smoothness227_g60054;
				#endif
				...
				half Global_Extras_Wetness305_g60054 = break89_g62109.g;
				...
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float staticSwitch4066_g60054 = Main_Occlusion247_g60054;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float staticSwitch4066_g60054 = lerpResult294_g60054;
				#else
				float staticSwitch4066_g60054 = Main_Occlusion247_g60054;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				...
				#elif defined(TVE_DETAIL_MODE_ON)
				float staticSwitch310_g60054 = staticSwitch4066_g60054;
				#else
				float staticSwitch310_g60054 = Main_Occlusion247_g60054;
				#endif
				...
				half Fade_Camera3743_g60054 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g60054 );
				half Final_AlphaFade3727_g60054 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g60054 ) ).r ) ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float lerpResult4755_g60054 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g60054;
				o.ase_texcoord6.x = vertexToFrag11_g62121;
				float3 vertexToFrag3890_g60054 = ase_worldPos;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float localCustomAlphaClip3735_g60054 = ( 0.0 );
				float vertexToFrag11_g62121 = IN.ase_texcoord6.x;
				half Fade_Camera3743_g60054 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g60054 );
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;2917.487;710.213;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;398;-1344,-896;Inherit;False;Compile All Shaders;-1;;62152;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D451CE39F14FE883CF61272FA613CA66B86A7CE4
