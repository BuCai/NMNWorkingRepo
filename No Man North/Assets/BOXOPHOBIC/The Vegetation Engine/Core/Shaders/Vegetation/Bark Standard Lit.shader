	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Vertex_Motion_Object833_g55655 = ( ( VertexPosRotationAxis50_g62072 + ( VertexPosOtherAxis82_g62072 * cos( Angle44_g62072 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g62072 ) * sin( Angle44_g62072 ) ) ) + Motion_20_Vertical4280_g55655 + Motion_20_Squash4418_g55655 );
				...
				float2 Mesh_DetailCoord3_g55655 = appendResult21_g62073;
				float2 vertexToFrag11_g62089 = ( ( Mesh_DetailCoord3_g55655 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord8.zw = vertexToFrag11_g62089;
				half Mesh_DetailMask90_g55655 = v.ase_color.b;
				float vertexToFrag11_g62105 = ( ( Mesh_DetailMask90_g55655 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord9.x = vertexToFrag11_g62105;
				...
				o.ase_texcoord10.x = vertexToFrag11_g62138;
				
				float2 vertexToFrag11_g62119 = ( ( v.texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord10.yz = vertexToFrag11_g62119;
				...
				o.ase_texcoord10.w = vertexToFrag11_g62121;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 vertexToFrag11_g62089 = IN.ase_texcoord8.zw;
				half2 Second_UVs17_g55655 = vertexToFrag11_g62089;
				...
				#endif
				float vertexToFrag11_g62105 = IN.ase_texcoord9.x;
				float temp_output_3919_0_g55655 = vertexToFrag11_g62105;
				...
				half Mask_Detail147_g55655 = saturate( ( ( saturate( ( Blend_Source1540_g55655 + ( Blend_Source1540_g55655 * lerpResult4058_g55655 ) ) ) - temp_output_7_0_g62150 ) / ( _DetailBlendMaxValue - temp_output_7_0_g62150 ) ) );
				float3 lerpResult235_g55655 = lerp( Main_Albedo99_g55655 , ( Main_Albedo99_g55655 * Second_Albedo153_g55655 * staticSwitch1_g62071 ) , Mask_Detail147_g55655);
				...
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( ( lerpResult3567_g55655 * 0.5 ) + staticSwitch3574_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				...
				float vertexToFrag11_g62138 = IN.ase_texcoord10.x;
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , vertexToFrag11_g62138);
				...
				float3 staticSwitch267_g55655 = Main_Normal137_g55655;
				#endif
				float3 temp_output_13_0_g62074 = staticSwitch267_g55655;
				...
				float2 vertexToFrag11_g62119 = IN.ase_texcoord10.yz;
				...
				float vertexToFrag11_g62121 = IN.ase_texcoord10.w;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g55655 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult21_g62073 = (float2(v.texcoord0.z , v.texcoord0.w));
				float2 Mesh_DetailCoord3_g55655 = appendResult21_g62073;
				float2 vertexToFrag11_g62089 = ( ( Mesh_DetailCoord3_g55655 * (_SecondUVs).xy ) + (_SecondUVs).zw );
				o.ase_texcoord4.zw = vertexToFrag11_g62089;
				half Mesh_DetailMask90_g55655 = v.ase_color.b;
				float vertexToFrag11_g62105 = ( ( Mesh_DetailMask90_g55655 - 0.5 ) + _DetailMeshValue );
				o.ase_texcoord5.x = vertexToFrag11_g62105;
				...
				float temp_output_3377_0_g55655 = saturate( ( ( Mesh_Occlusion318_g55655 - temp_output_7_0_g62136 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g62136 ) ) );
				float vertexToFrag11_g62138 = temp_output_3377_0_g55655;
				o.ase_texcoord6.w = vertexToFrag11_g62138;
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord7.w = vertexToFrag11_g62121;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode29_g55655 = tex2D( _MainAlbedoTex, Main_UVs15_g55655 );
				half3 Main_Albedo99_g55655 = ( lerpResult4519_g55655 * (tex2DNode29_g55655).rgb );
				float2 vertexToFrag11_g62089 = IN.ase_texcoord4.zw;
				half2 Second_UVs17_g55655 = vertexToFrag11_g62089;
				half3 Second_Albedo153_g55655 = (( _SecondColor * tex2D( _SecondAlbedoTex, Second_UVs17_g55655 ) )).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g62071 = 2.0;
				...
				float staticSwitch1_g62071 = 4.594794;
				#endif
				float vertexToFrag11_g62105 = IN.ase_texcoord5.x;
				float temp_output_3919_0_g55655 = vertexToFrag11_g62105;
				half Blend_Source1540_g55655 = temp_output_3919_0_g55655;
				float4 tex2DNode35_g55655 = tex2D( _MainMaskTex, Main_UVs15_g55655 );
				half Main_Mask57_g55655 = tex2DNode35_g55655.b;
				...
				half3 Final_Albedo359_g55655 = lerpResult336_g55655;
				float3 temp_cast_3 = (1.0).xxx;
				float vertexToFrag11_g62138 = IN.ase_texcoord6.w;
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_3 , vertexToFrag11_g62138);
				float3 Vertex_Occlusion648_g55655 = lerpResult2945_g55655;
				...
				float localCustomAlphaClip3735_g55655 = ( 0.0 );
				float vertexToFrag11_g62121 = IN.ase_texcoord7.w;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g55655 );
				half Final_AlphaFade3727_g55655 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g55655 ) ).r ) ) );
				float Main_Alpha316_g55655 = ( _MainColor.a * tex2DNode29_g55655.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord5.y = vertexToFrag11_g62121;
				o.ase_texcoord6.xyz = vertexToFrag3890_g55655;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float localCustomAlphaClip3735_g55655 = ( 0.0 );
				float vertexToFrag11_g62121 = IN.ase_texcoord5.y;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g55655 );
				float3 vertexToFrag3890_g55655 = IN.ase_texcoord6.xyz;
				float3 WorldPosition3905_g55655 = vertexToFrag3890_g55655;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord.x = vertexToFrag11_g62121;
				o.ase_texcoord.yzw = vertexToFrag3890_g55655;
				float2 vertexToFrag11_g62084 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.xy = vertexToFrag11_g62084;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float localCustomAlphaClip3735_g55655 = ( 0.0 );
				float vertexToFrag11_g62121 = IN.ase_texcoord.x;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Camera3743_g55655 );
				float3 vertexToFrag3890_g55655 = IN.ase_texcoord.yzw;
				float3 WorldPosition3905_g55655 = vertexToFrag3890_g55655;
				half Final_AlphaFade3727_g55655 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g55655 ) ).r ) ) );
				float2 vertexToFrag11_g62084 = IN.ase_texcoord1.xy;
				half2 Main_UVs15_g55655 = vertexToFrag11_g62084;
				float4 tex2DNode29_g55655 = tex2D( _MainAlbedoTex, Main_UVs15_g55655 );
				float Main_Alpha316_g55655 = ( _MainColor.a * tex2DNode29_g55655.a );
				half AlphaTreshold2132_g55655 = _Cutoff;
...
Node;AmplifyShaderEditor.FunctionNode;307;-2176,384;Inherit;False;Define Shader Vegetation;-1;;62152;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C2920F6FE7366FB2D255918837A00CB65064E691
