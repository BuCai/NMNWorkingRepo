	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 VertexPos40_g62096 = temp_output_2283_0_g55655;
				...
				float3 vertexToFrag4224_g55655 = temp_output_114_0_g62080;
				half3 ObjectData20_g62075 = vertexToFrag4224_g55655;
				float3 vertexToFrag3890_g55655 = ase_worldPos;
				half3 WorldData19_g62075 = vertexToFrag3890_g55655;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g62075 = WorldData19_g62075;
				#else
				float3 staticSwitch14_g62075 = ObjectData20_g62075;
				#endif
				float3 ObjectPosition4223_g55655 = staticSwitch14_g62075;
				float3 Position83_g62127 = ObjectPosition4223_g55655;
				...
				half4 Global_Motion_Params3909_g55655 = lerpResult87_g62127;
				float4 break322_g62099 = Global_Motion_Params3909_g55655;
				...
				half2 Global_MotionDirectionOS39_g55655 = (( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g62099 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half ObjectData20_g62106 = 3.14;
				float Bounds_Height374_g55655 = _MaxBoundsInfo.y;
				half WorldData19_g62106 = ( Bounds_Height374_g55655 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62106 = WorldData19_g62106;
				#else
				float staticSwitch14_g62106 = ObjectData20_g62106;
				#endif
				float Motion_Max_Bending1133_g55655 = staticSwitch14_g62106;
				...
				float3 break111_g62098 = ObjectPosition4223_g55655;
				float Mesh_Variation16_g55655 = v.ase_color.r;
				half VertexDynamicMode4798_g55655 = _VertexDynamicMode;
				float lerpResult4795_g55655 = lerp( frac( ( v.ase_color.r + ( break111_g62098.x + break111_g62098.z ) ) ) , Mesh_Variation16_g55655 , VertexDynamicMode4798_g55655);
				half ObjectData20_g62094 = lerpResult4795_g55655;
				half WorldData19_g62094 = Mesh_Variation16_g55655;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62094 = WorldData19_g62094;
				#else
				float staticSwitch14_g62094 = ObjectData20_g62094;
				#endif
				half Motion_Variation3073_g55655 = staticSwitch14_g62094;
				half Motion_10_Variation4581_g55655 = ( _MotionVariation_10 * Motion_Variation3073_g55655 );
				half Motion_Variation284_g62087 = Motion_10_Variation4581_g55655;
				...
				half Global_MotionPower_103106_g55655 = ( lerpResult376_g62099 * Wind_Stop420_g62099 );
				half Input_WindPower327_g62087 = Global_MotionPower_103106_g55655;
				...
				half Motion_10_SinWaveAm4570_g55655 = lerpResult321_g62087;
				float2 panner437_g62099 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g55655).xz * TVE_NoiseParams.z ));
				...
				half Global_MotionNoise34_g55655 = pow( saferPower446_g62099 , lerpResult448_g62099 );
				...
				half ObjectData20_g62102 = lerpResult4494_g55655;
				half WorldData19_g62102 = Mesh_Motion_1082_g55655;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62102 = WorldData19_g62102;
				#else
				float staticSwitch14_g62102 = ObjectData20_g62102;
				#endif
				half Motion_10_Interaction53_g55655 = ( Interaction_Amplitude4137_g55655 * Motion_Max_Bending1133_g55655 * staticSwitch14_g62102 );
				half Global_InteractionMask66_g55655 = ( break322_g62099.w * break322_g62099.w );
				...
				half Angle44_g62096 = Vertex_ZAxisRotatin190_g55655;
				...
				half Angle44_g62104 = -Vertex_XAxisRotation216_g55655;
				...
				half Global_MotionPower_203109_g55655 = ( lerpResult410_g62099 * Wind_Stop420_g62099 );
				half Motion_20_Variation4255_g55655 = ( _MotionVariation_20 * Motion_Variation3073_g55655 );
				half Variation127_g62091 = ( Motion_20_Variation4255_g55655 * Motion_Variation3073_g55655 );
				...
				half Global_MotionPower2223_g55655 = ( Wind_Power369_g62099 * Wind_Stop420_g62099 );
				float temp_output_112_0_g62091 = Global_MotionPower2223_g55655;
				...
				half Motion_Selective4260_g55655 = lerpResult126_g62091;
				...
				half Input_Speed62_g62085 = Motion_20_Speed4257_g55655;
				float mulTime354_g62085 = _TimeParameters.x * Input_Speed62_g62085;
				float Motion_Variation284_g62085 = Motion_20_Variation4255_g55655;
				half Motion_20_Scale4256_g55655 = _MotionScale_20;
				float Motion_Scale287_g62085 = ( Motion_20_Scale4256_g55655 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveA4382_g55655 = sin( ( mulTime354_g62085 + Motion_Variation284_g62085 + Motion_Scale287_g62085 ) );
				half ObjectData20_g62086 = 3.14;
				float Bounds_Radius121_g55655 = _MaxBoundsInfo.x;
				half WorldData19_g62086 = Bounds_Radius121_g55655;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62086 = WorldData19_g62086;
				#else
				float staticSwitch14_g62086 = ObjectData20_g62086;
				#endif
				float Motion_Max_Rolling1137_g55655 = staticSwitch14_g62086;
				...
				half Angle44_g62072 = Motion_20_Rolling138_g55655;
				half Input_Speed62_g62141 = ( Motion_20_Speed4257_g55655 - 1.0 );
				float mulTime354_g62141 = _TimeParameters.x * Input_Speed62_g62141;
				float Motion_Variation284_g62141 = Motion_20_Variation4255_g55655;
				float Motion_Scale287_g62141 = ( Motion_20_Scale4256_g55655 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Motion_20_SineWaveB4460_g55655 = sin( ( mulTime354_g62141 + Motion_Variation284_g62141 + Motion_Scale287_g62141 ) );
				...
				float Motion_Variation330_g62079 = ( _MotionVariation_32 * Motion_Variation3073_g55655 );
				half Input_Amplitude58_g62079 = ( _MotionAmplitude_32 * Bounds_Radius121_g55655 * 0.1 );
				...
				half Global_MotionPower_303115_g55655 = ( lerpResult378_g62099 * Wind_Stop420_g62099 );
				float temp_output_7_0_g62093 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g55655 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62093 ) / ( TVE_MotionFadeStart - temp_output_7_0_g62093 ) ) );
				half3 Motion_30_Details263_g55655 = ( temp_output_299_0_g62079 * ( Global_MotionNoise34_g55655 * Mesh_Motion_30144_g55655 * Global_MotionPower_303115_g55655 * Wind_FadeOut4005_g55655 * Motion_Selective4260_g55655 ) );
				float3 Vertex_Motion_Object833_g55655 = ( ( ( VertexPosRotationAxis50_g62072 + ( VertexPosOtherAxis82_g62072 * cos( Angle44_g62072 ) ) + ( cross( float3(0,1,0) , VertexPosOtherAxis82_g62072 ) * sin( Angle44_g62072 ) ) ) + Motion_20_Vertical4280_g55655 + Motion_20_Squash4418_g55655 ) + Motion_30_Details263_g55655 );
				...
				float3 Position83_g62115 = ObjectPosition4223_g55655;
				...
				half4 Global_Object_Params4173_g55655 = lerpResult87_g62115;
				...
				float lerpResult346_g55655 = lerp( 1.0 , Global_VertexSize174_g55655 , lerpResult16_g62149);
				float3 appendResult3480_g55655 = (float3(lerpResult346_g55655 , lerpResult346_g55655 , lerpResult346_g55655));
				half3 ObjectData20_g62147 = appendResult3480_g55655;
				...
				#endif
				half3 Vertex_Size1741_g55655 = staticSwitch14_g62147;
				...
				half Gradient_Tint2784_g55655 = saturate( ( ( Mesh_Height1524_g55655 - temp_output_7_0_g62140 ) / ( _GradientMaxValue - temp_output_7_0_g62140 ) ) );
				float vertexToFrag11_g62137 = Gradient_Tint2784_g55655;
				...
				half Noise_Tint2802_g55655 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_8 * WorldPosition3905_g55655 * 0.1 ), 0.0) ).r - temp_output_7_0_g62120 ) / ( _NoiseMaxValue - temp_output_7_0_g62120 ) ) );
				float vertexToFrag11_g62143 = Noise_Tint2802_g55655;
				...
				float temp_output_3377_0_g55655 = saturate( ( ( Mesh_Occlusion318_g55655 - temp_output_7_0_g62136 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g62136 ) ) );
				float vertexToFrag11_g62138 = temp_output_3377_0_g55655;
				o.ase_texcoord9.w = vertexToFrag11_g62138;
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord10.z = vertexToFrag11_g62121;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float3 lerpResult2779_g55655 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g62137);
				float vertexToFrag11_g62143 = IN.ase_texcoord8.y;
				float3 lerpResult2800_g55655 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g62143);
				...
				half2 Main_UVs15_g55655 = vertexToFrag11_g62084;
				...
				float3 WorldPosition3905_g55655 = vertexToFrag3890_g55655;
				float3 Position58_g62122 = WorldPosition3905_g55655;
				...
				half Global_ColorsTex_A1701_g55655 = (lerpResult88_g62122).a;
				...
				half3 Global_ColorsTex_RGB1700_g55655 = (lerpResult88_g62122).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g62151 = 2.0;
				#else
				float staticSwitch1_g62151 = 4.594794;
				#endif
				half3 Global_Colors1954_g55655 = ( Global_ColorsTex_RGB1700_g55655 * staticSwitch1_g62151 );
				...
				half Global_Colors_Mask3692_g55655 = saturate( ( ( Main_Mask57_g55655 - temp_output_7_0_g62131 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g62131 ) ) );
				float lerpResult16_g62101 = lerp( 0.0 , ( Global_Colors_Value3650_g55655 * Global_Colors_Mask3692_g55655 ) , TVE_Enabled);
				float3 lerpResult3628_g55655 = lerp( Blend_AlbedoTinted2808_g55655 , ( lerpResult3618_g55655 * Global_Colors1954_g55655 ) , lerpResult16_g62101);
				...
				half Subsurface_Mask1557_g55655 = saturate( ( ( Main_Mask57_g55655 - temp_output_7_0_g62148 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g62148 ) ) );
				...
				float3 Position82_g62109 = WorldPosition3905_g55655;
				...
				half Global_Extras_Overlay156_g55655 = break89_g62109.b;
				...
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( ( lerpResult3567_g55655 * 0.5 ) + Main_AlbedoTex_G3526_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				...
				float vertexToFrag11_g62138 = IN.ase_texcoord9.w;
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , vertexToFrag11_g62138);
				float3 Vertex_Occlusion648_g55655 = lerpResult2945_g55655;
				
				float3 temp_output_13_0_g62074 = Main_Normal137_g55655;
				float3 switchResult12_g62074 = (((ase_vface>0)?(temp_output_13_0_g62074):(( temp_output_13_0_g62074 * _render_normals_options ))));
				half3 Blend_Normal312_g55655 = switchResult12_g62074;
				...
				half2 Emissive_UVs2468_g55655 = vertexToFrag11_g62119;
				half Global_Extras_Emissive4203_g55655 = break89_g62109.r;
				...
				half Global_Extras_Wetness305_g55655 = break89_g62109.g;
				...
				float vertexToFrag11_g62121 = IN.ase_texcoord10.z;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( Fade_Glancing3853_g55655 * Fade_Camera3743_g55655 );
				half Final_AlphaFade3727_g55655 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g55655 ) ).r ) ) );
				...
				half Global_Extras_Alpha1033_g55655 = break89_g62109.a;
				...
				float lerpResult4011_g55655 = lerp( 1.0 , staticSwitch4017_g55655 , lerpResult16_g62113);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_3377_0_g55655 = saturate( ( ( Mesh_Occlusion318_g55655 - temp_output_7_0_g62136 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g62136 ) ) );
				float vertexToFrag11_g62138 = temp_output_3377_0_g55655;
				o.ase_texcoord5.w = vertexToFrag11_g62138;
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord6.w = vertexToFrag11_g62121;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half3 Final_Albedo359_g55655 = lerpResult336_g55655;
				float3 temp_cast_7 = (1.0).xxx;
				float vertexToFrag11_g62138 = IN.ase_texcoord5.w;
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , vertexToFrag11_g62138);
				float3 Vertex_Occlusion648_g55655 = lerpResult2945_g55655;
				...
				float lerpResult3993_g55655 = lerp( 1.0 , saturate( abs( dotResult3851_g55655 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g55655 = lerpResult3993_g55655;
				float vertexToFrag11_g62121 = IN.ase_texcoord6.w;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( Fade_Glancing3853_g55655 * Fade_Camera3743_g55655 );
				half Final_AlphaFade3727_g55655 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g55655 ) ).r ) ) );
				float Main_Alpha316_g55655 = ( _MainColor.a * tex2DNode29_g55655.a );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord4.z = vertexToFrag11_g62121;
				o.ase_texcoord5.xyz = vertexToFrag3890_g55655;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float lerpResult3993_g55655 = lerp( 1.0 , saturate( abs( dotResult3851_g55655 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g55655 = lerpResult3993_g55655;
				float vertexToFrag11_g62121 = IN.ase_texcoord4.z;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( Fade_Glancing3853_g55655 * Fade_Camera3743_g55655 );
				float3 vertexToFrag3890_g55655 = IN.ase_texcoord5.xyz;
				float3 WorldPosition3905_g55655 = vertexToFrag3890_g55655;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float lerpResult4755_g55655 = lerp( 1.0 , saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g62146 ) / ( TVE_CameraFadeEnd - temp_output_7_0_g62146 ) ) ) , _FadeCameraValue);
				float vertexToFrag11_g62121 = lerpResult4755_g55655;
				o.ase_texcoord.w = vertexToFrag11_g62121;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float lerpResult3993_g55655 = lerp( 1.0 , saturate( abs( dotResult3851_g55655 ) ) , _FadeGlancingValue);
				half Fade_Glancing3853_g55655 = lerpResult3993_g55655;
				float vertexToFrag11_g62121 = IN.ase_texcoord.w;
				half Fade_Camera3743_g55655 = vertexToFrag11_g62121;
				float temp_output_41_0_g62144 = ( Fade_Glancing3853_g55655 * Fade_Camera3743_g55655 );
...
/*ASEBEGIN
Version=18934
1920;0;1920;1029;2811.365;706.4889;1;True;False
...
ASEEND*/
//CHKSM=A5A5A01C8163B83A649390196AC2E75E2EB1C2DC
