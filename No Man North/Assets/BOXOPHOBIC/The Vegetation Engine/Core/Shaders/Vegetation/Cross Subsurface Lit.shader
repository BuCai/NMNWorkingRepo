	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g61919 = v.vertex.xyz;
				half3 Mesh_PivotsOS2291_g61919 = half3(0,0,0);
				float3 temp_output_2283_0_g61919 = ( VertexPosition3588_g61919 - Mesh_PivotsOS2291_g61919 );
				half3 VertexPos40_g62096 = temp_output_2283_0_g61919;
				...
				float3 vertexToFrag4224_g61919 = temp_output_114_0_g62080;
				half3 ObjectData20_g62075 = vertexToFrag4224_g61919;
				float3 vertexToFrag3890_g61919 = ase_worldPos;
				half3 WorldData19_g62075 = vertexToFrag3890_g61919;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g62075 = WorldData19_g62075;
				#else
				float3 staticSwitch14_g62075 = ObjectData20_g62075;
				#endif
				float3 ObjectPosition4223_g61919 = staticSwitch14_g62075;
				float3 Position83_g62127 = ObjectPosition4223_g61919;
				...
				half4 Global_Motion_Params3909_g61919 = lerpResult87_g62127;
				float4 break322_g62099 = Global_Motion_Params3909_g61919;
				...
				half2 Global_MotionDirectionOS39_g61919 = (( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g62099 , 0.0 ) ).xyz * ase_parentObjectScale )).xz;
				half ObjectData20_g62106 = 3.14;
				float Bounds_Height374_g61919 = _MaxBoundsInfo.y;
				half WorldData19_g62106 = ( Bounds_Height374_g61919 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62106 = WorldData19_g62106;
				#else
				float staticSwitch14_g62106 = ObjectData20_g62106;
				#endif
				float Motion_Max_Bending1133_g61919 = staticSwitch14_g62106;
				half Mesh_Motion_1082_g61919 = v.ase_texcoord3.x;
				half Motion_10_Mask4617_g61919 = ( _MotionAmplitude_10 * Motion_Max_Bending1133_g61919 * Mesh_Motion_1082_g61919 );
				half Input_Speed62_g62087 = _MotionSpeed_10;
				float mulTime373_g62087 = _TimeParameters.x * Input_Speed62_g62087;
				float3 break111_g62098 = ObjectPosition4223_g61919;
				float Mesh_Variation16_g61919 = v.ase_color.r;
				half VertexDynamicMode4798_g61919 = _VertexDynamicMode;
				float lerpResult4795_g61919 = lerp( frac( ( v.ase_color.r + ( break111_g62098.x + break111_g62098.z ) ) ) , Mesh_Variation16_g61919 , VertexDynamicMode4798_g61919);
				half ObjectData20_g62094 = lerpResult4795_g61919;
				half WorldData19_g62094 = Mesh_Variation16_g61919;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62094 = WorldData19_g62094;
				#else
				float staticSwitch14_g62094 = ObjectData20_g62094;
				#endif
				half Motion_Variation3073_g61919 = staticSwitch14_g62094;
				half Motion_10_Variation4581_g61919 = ( _MotionVariation_10 * Motion_Variation3073_g61919 );
				half Motion_Variation284_g62087 = Motion_10_Variation4581_g61919;
				...
				half Global_MotionPower_103106_g61919 = ( lerpResult376_g62099 * Wind_Stop420_g62099 );
				half Input_WindPower327_g62087 = Global_MotionPower_103106_g61919;
				...
				half Motion_10_SinWaveAm4570_g61919 = lerpResult321_g62087;
				float2 panner437_g62099 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4223_g61919).xz * TVE_NoiseParams.z ));
				...
				half Global_MotionNoise34_g61919 = pow( saferPower446_g62099 , lerpResult448_g62099 );
				half Motion_10_Bending2258_g61919 = ( Motion_10_Mask4617_g61919 * Motion_10_SinWaveAm4570_g61919 * Global_MotionPower_103106_g61919 * Global_MotionNoise34_g61919 );
				half Interaction_Amplitude4137_g61919 = _InteractionAmplitude;
				float lerpResult4494_g61919 = lerp( 1.0 , Mesh_Motion_1082_g61919 , _InteractionMaskValue);
				half ObjectData20_g62102 = lerpResult4494_g61919;
				half WorldData19_g62102 = Mesh_Motion_1082_g61919;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g62102 = WorldData19_g62102;
				#else
				float staticSwitch14_g62102 = ObjectData20_g62102;
				#endif
				half Motion_10_Interaction53_g61919 = ( Interaction_Amplitude4137_g61919 * Motion_Max_Bending1133_g61919 * staticSwitch14_g62102 );
				half Global_InteractionMask66_g61919 = ( break322_g62099.w * break322_g62099.w );
				float lerpResult4685_g61919 = lerp( Motion_10_Bending2258_g61919 , Motion_10_Interaction53_g61919 , saturate( ( Global_InteractionMask66_g61919 * Interaction_Amplitude4137_g61919 ) ));
				float2 break4603_g61919 = ( Global_MotionDirectionOS39_g61919 * lerpResult4685_g61919 );
				half Vertex_ZAxisRotatin190_g61919 = break4603_g61919.y;
				half Angle44_g62096 = Vertex_ZAxisRotatin190_g61919;
				...
				half Vertex_XAxisRotation216_g61919 = break4603_g61919.x;
				half Angle44_g62104 = -Vertex_XAxisRotation216_g61919;
				float3 Vertex_Motion_Object833_g61919 = ( VertexPosRotationAxis50_g62104 + ( VertexPosOtherAxis82_g62104 * cos( Angle44_g62104 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g62104 ) * sin( Angle44_g62104 ) ) );
				float3 temp_output_3474_0_g61919 = ( VertexPosition3588_g61919 - Mesh_PivotsOS2291_g61919 );
				float3 appendResult2043_g61919 = (float3(Vertex_XAxisRotation216_g61919 , 0.0 , Vertex_ZAxisRotatin190_g61919));
				float3 Vertex_Motion_World1118_g61919 = ( temp_output_3474_0_g61919 + appendResult2043_g61919 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g61919 = Vertex_Motion_World1118_g61919;
				#else
				float3 staticSwitch3312_g61919 = ( Vertex_Motion_Object833_g61919 + ( 0.0 * _VertexDataMode ) );
				#endif
				float4 temp_output_94_19_g62115 = TVE_VertexCoords;
				float3 Position83_g62115 = ObjectPosition4223_g61919;
				...
				half4 Global_Object_Params4173_g61919 = lerpResult87_g62115;
				half Global_VertexSize174_g61919 = Global_Object_Params4173_g61919.w;
				float lerpResult16_g62149 = lerp( 0.0 , _GlobalSize , TVE_Enabled);
				float lerpResult346_g61919 = lerp( 1.0 , Global_VertexSize174_g61919 , lerpResult16_g62149);
				float3 appendResult3480_g61919 = (float3(lerpResult346_g61919 , lerpResult346_g61919 , lerpResult346_g61919));
				half3 ObjectData20_g62147 = appendResult3480_g61919;
				...
				#endif
				half3 Vertex_Size1741_g61919 = staticSwitch14_g62147;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g61919 = _Vector5;
				half3 Grass_Perspective2661_g61919 = half3(0,0,0);
				float3 Final_VertexPosition890_g61919 = ( ( ( staticSwitch3312_g61919 * Vertex_Size1741_g61919 * Vertex_SizeFade1740_g61919 ) + Mesh_PivotsOS2291_g61919 + Grass_Perspective2661_g61919 ) + _DisableSRPBatcher );
				
				half Mesh_Height1524_g61919 = v.ase_color.a;
				float temp_output_7_0_g62140 = _GradientMinValue;
				half Gradient_Tint2784_g61919 = saturate( ( ( Mesh_Height1524_g61919 - temp_output_7_0_g62140 ) / ( _GradientMaxValue - temp_output_7_0_g62140 ) ) );
				float vertexToFrag11_g62137 = Gradient_Tint2784_g61919;
				o.ase_texcoord8.x = vertexToFrag11_g62137;
				float3 temp_cast_8 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				float temp_output_7_0_g62120 = _NoiseMinValue;
				half Noise_Tint2802_g61919 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_8 * WorldPosition3905_g61919 * 0.1 ), 0.0) ).r - temp_output_7_0_g62120 ) / ( _NoiseMaxValue - temp_output_7_0_g62120 ) ) );
				float vertexToFrag11_g62143 = Noise_Tint2802_g61919;
				o.ase_texcoord8.y = vertexToFrag11_g62143;
				float2 vertexToFrag11_g62084 = ( ( v.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord8.zw = vertexToFrag11_g62084;
				o.ase_texcoord9.xyz = vertexToFrag3890_g61919;
				
				float2 vertexToFrag11_g62119 = ( ( v.texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord10.xy = vertexToFrag11_g62119;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g61919;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float vertexToFrag11_g62137 = IN.ase_texcoord8.x;
				float3 lerpResult2779_g61919 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g62137);
				float vertexToFrag11_g62143 = IN.ase_texcoord8.y;
				float3 lerpResult2800_g61919 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g62143);
				half Leaves_Mask4511_g61919 = 1.0;
				float3 lerpResult4521_g61919 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g61919 * lerpResult2800_g61919 * float3(1,1,1) ) , Leaves_Mask4511_g61919);
				float3 lerpResult4519_g61919 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g61919);
				float2 vertexToFrag11_g62084 = IN.ase_texcoord8.zw;
				half2 Main_UVs15_g61919 = vertexToFrag11_g62084;
				float4 tex2DNode29_g61919 = tex2D( _MainAlbedoTex, Main_UVs15_g61919 );
				half3 Main_Albedo99_g61919 = ( lerpResult4519_g61919 * (tex2DNode29_g61919).rgb );
				half3 Blend_Albedo265_g61919 = Main_Albedo99_g61919;
				half3 Blend_AlbedoTinted2808_g61919 = ( lerpResult4521_g61919 * Blend_Albedo265_g61919 );
				float dotResult3616_g61919 = dot( Blend_AlbedoTinted2808_g61919 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g61919).xxx;
				float4 temp_output_91_19_g62122 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g61919 = IN.ase_texcoord9.xyz;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				float3 Position58_g62122 = WorldPosition3905_g61919;
				...
				half Global_ColorsTex_A1701_g61919 = (lerpResult88_g62122).a;
				half Global_Colors_Influence3668_g61919 = saturate( Global_ColorsTex_A1701_g61919 );
				float3 lerpResult3618_g61919 = lerp( Blend_AlbedoTinted2808_g61919 , temp_cast_0 , Global_Colors_Influence3668_g61919);
				half3 Global_ColorsTex_RGB1700_g61919 = (lerpResult88_g62122).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g62151 = 2.0;
				#else
				float staticSwitch1_g62151 = 4.594794;
				#endif
				half3 Global_Colors1954_g61919 = ( Global_ColorsTex_RGB1700_g61919 * staticSwitch1_g62151 );
				half Global_Colors_Value3650_g61919 = _GlobalColors;
				float4 tex2DNode35_g61919 = tex2D( _MainMaskTex, Main_UVs15_g61919 );
				half Main_Mask57_g61919 = tex2DNode35_g61919.b;
				float temp_output_7_0_g62131 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g61919 = saturate( ( ( Main_Mask57_g61919 - temp_output_7_0_g62131 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g62131 ) ) );
				float lerpResult16_g62101 = lerp( 0.0 , ( Global_Colors_Value3650_g61919 * Global_Colors_Mask3692_g61919 ) , TVE_Enabled);
				float3 lerpResult3628_g61919 = lerp( Blend_AlbedoTinted2808_g61919 , ( lerpResult3618_g61919 * Global_Colors1954_g61919 ) , lerpResult16_g62101);
				half3 Blend_AlbedoColored863_g61919 = lerpResult3628_g61919;
				float3 temp_output_799_0_g61919 = (_SubsurfaceColor).rgb;
				float dotResult3930_g61919 = dot( temp_output_799_0_g61919 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g61919).xxx;
				float3 lerpResult3932_g61919 = lerp( temp_output_799_0_g61919 , temp_cast_3 , Global_Colors_Influence3668_g61919);
				float3 lerpResult3942_g61919 = lerp( temp_output_799_0_g61919 , ( lerpResult3932_g61919 * Global_Colors1954_g61919 ) , ( Global_Colors_Value3650_g61919 * Global_Colors_Mask3692_g61919 ));
				half3 Subsurface_Color1722_g61919 = lerpResult3942_g61919;
				half MainLight_Subsurface4041_g61919 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g61919 = ( _SubsurfaceValue * MainLight_Subsurface4041_g61919 );
				float temp_output_7_0_g62148 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g61919 = saturate( ( ( Main_Mask57_g61919 - temp_output_7_0_g62148 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g62148 ) ) );
				half3 Subsurface_Transmission884_g61919 = ( Subsurface_Color1722_g61919 * Subsurface_Intensity1752_g61919 * Subsurface_Mask1557_g61919 );
				half3 MainLight_Direction3926_g61919 = TVE_MainLightDirection;
				float3 normalizeResult2169_g61919 = normalize( WorldViewDirection );
				float3 ViewDir_Normalized3963_g61919 = normalizeResult2169_g61919;
				float dotResult785_g61919 = dot( -MainLight_Direction3926_g61919 , ViewDir_Normalized3963_g61919 );
				float saferPower1624_g61919 = abs( (dotResult785_g61919*0.5 + 0.5) );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g61919 = 0.0;
				#else
				float staticSwitch1602_g61919 = ( pow( saferPower1624_g61919 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g61919 = staticSwitch1602_g61919;
				half3 Subsurface_Scattering1693_g61919 = ( Subsurface_Transmission884_g61919 * Blend_AlbedoColored863_g61919 * Mask_Subsurface_View782_g61919 );
				half3 Blend_AlbedoAndSubsurface149_g61919 = ( Blend_AlbedoColored863_g61919 + Subsurface_Scattering1693_g61919 );
				half3 Global_OverlayColor1758_g61919 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g61919 = tex2DNode29_g61919.g;
				float4 temp_output_93_19_g62109 = TVE_ExtrasCoords;
				float3 Position82_g62109 = WorldPosition3905_g61919;
				...
				half Global_Extras_Overlay156_g61919 = break89_g62109.b;
				half Overlay_Variation4560_g61919 = 1.0;
				half Overlay_Commons1365_g61919 = ( _GlobalOverlay * Global_Extras_Overlay156_g61919 * Overlay_Variation4560_g61919 );
				float temp_output_7_0_g62145 = _OverlayMaskMinValue;
				half Overlay_Mask269_g61919 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g61919 ) * Overlay_Commons1365_g61919 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				float3 lerpResult336_g61919 = lerp( Blend_AlbedoAndSubsurface149_g61919 , Global_OverlayColor1758_g61919 , Overlay_Mask269_g61919);
				half3 Final_Albedo359_g61919 = lerpResult336_g61919;
				
				float3 unpack4112_g61919 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g61919 ), _MainNormalValue );
				unpack4112_g61919.z = lerp( 1, unpack4112_g61919.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g61919 = unpack4112_g61919;
				float3 temp_output_13_0_g62074 = Main_Normal137_g61919;
				float3 switchResult12_g62074 = (((ase_vface>0)?(temp_output_13_0_g62074):(( temp_output_13_0_g62074 * _render_normals_options ))));
				half3 Blend_Normal312_g61919 = switchResult12_g62074;
				half3 Final_Normal366_g61919 = Blend_Normal312_g61919;
				
				float4 temp_output_4214_0_g61919 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g62119 = IN.ase_texcoord10.xy;
				half2 Emissive_UVs2468_g61919 = vertexToFrag11_g62119;
				half Global_Extras_Emissive4203_g61919 = break89_g62109.r;
				float lerpResult4206_g61919 = lerp( 1.0 , Global_Extras_Emissive4203_g61919 , _GlobalEmissive);
				half3 Final_Emissive2476_g61919 = ( (( temp_output_4214_0_g61919 * tex2D( _EmissiveTex, Emissive_UVs2468_g61919 ) )).rgb * lerpResult4206_g61919 );
				
				float3 temp_cast_7 = (( 0.04 * _RenderSpecular )).xxx;
				
				half Main_Smoothness227_g61919 = ( tex2DNode35_g61919.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g61919 = Main_Smoothness227_g61919;
				half Global_OverlaySmoothness311_g61919 = TVE_OverlaySmoothness;
				float lerpResult343_g61919 = lerp( Blend_Smoothness314_g61919 , Global_OverlaySmoothness311_g61919 , Overlay_Mask269_g61919);
				half Final_Smoothness371_g61919 = lerpResult343_g61919;
				half Global_Extras_Wetness305_g61919 = break89_g62109.g;
				float lerpResult3673_g61919 = lerp( 0.0 , Global_Extras_Wetness305_g61919 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g61919 = saturate( ( Final_Smoothness371_g61919 + lerpResult3673_g61919 ) );
				
				float lerpResult240_g61919 = lerp( 1.0 , tex2DNode35_g61919.g , _MainOcclusionValue);
				half Main_Occlusion247_g61919 = lerpResult240_g61919;
				half Blend_Occlusion323_g61919 = Main_Occlusion247_g61919;
				
				float localCustomAlphaClip3735_g61919 = ( 0.0 );
				float3 normalizeResult3971_g61919 = normalize( cross( ddy( WorldPosition ) , ddx( WorldPosition ) ) );
				float3 NormalsWS_Derivates3972_g61919 = normalizeResult3971_g61919;
				float dotResult2161_g61919 = dot( ViewDir_Normalized3963_g61919 , NormalsWS_Derivates3972_g61919 );
				float dotResult2212_g61919 = dot( ViewDir_Normalized3963_g61919 , float3(0,1,0) );
				half Mask_HView2656_g61919 = dotResult2212_g61919;
				float lerpResult2221_g61919 = lerp( _FadeHorizontalValue , _FadeVerticalValue , Mask_HView2656_g61919);
				float lerpResult3992_g61919 = lerp( 1.0 , saturate( abs( dotResult2161_g61919 ) ) , lerpResult2221_g61919);
				half Fade_Billboard2175_g61919 = lerpResult3992_g61919;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Billboard2175_g61919 );
				half Final_AlphaFade3727_g61919 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g61919 ) ).r ) ) );
				float Main_Alpha316_g61919 = ( _MainColor.a * tex2DNode29_g61919.a );
				half AlphaTreshold2132_g61919 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g61919 = ( Main_Alpha316_g61919 - ( AlphaTreshold2132_g61919 - 0.5 ) );
				#else
				float staticSwitch3792_g61919 = Main_Alpha316_g61919;
				#endif
				half Final_Alpha3754_g61919 = staticSwitch3792_g61919;
				float temp_output_661_0_g61919 = ( Final_AlphaFade3727_g61919 * Final_Alpha3754_g61919 );
				float Alpha3735_g61919 = temp_output_661_0_g61919;
				float Treshold3735_g61919 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g61919 - Treshold3735_g61919);
				#endif
				}
				half Final_Clip914_g61919 = saturate( Alpha3735_g61919 );
				
				float3 Albedo = Final_Albedo359_g61919;
				float3 Normal = Final_Normal366_g61919;
				float3 Emission = Final_Emissive2476_g61919;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = Final_SmoothnessAndWetness4130_g61919;
				float Occlusion = Blend_Occlusion323_g61919;
				float Alpha = Final_Clip914_g61919;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
				float3 BakedGI = 0;
				float3 RefractionColor = 1;
				float RefractionIndex = 1;
				float3 Transmission = Subsurface_Transmission884_g61919;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				o.ase_texcoord2.xyz = vertexToFrag3890_g61919;
						 ...
						 ) : SV_TARGET
			{
				...
				float3 normalizeResult2169_g61919 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g61919 = normalizeResult2169_g61919;
				float3 normalizeResult3971_g61919 = normalize( cross( ddy( WorldPosition ) , ddx( WorldPosition ) ) );
				float3 NormalsWS_Derivates3972_g61919 = normalizeResult3971_g61919;
				float dotResult2161_g61919 = dot( ViewDir_Normalized3963_g61919 , NormalsWS_Derivates3972_g61919 );
				...
				half Fade_Billboard2175_g61919 = lerpResult3992_g61919;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Billboard2175_g61919 );
				float3 vertexToFrag3890_g61919 = IN.ase_texcoord2.xyz;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				half Final_AlphaFade3727_g61919 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g61919 ) ).r ) ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half Gradient_Tint2784_g61919 = saturate( ( ( Mesh_Height1524_g61919 - temp_output_7_0_g62140 ) / ( _GradientMaxValue - temp_output_7_0_g62140 ) ) );
				float vertexToFrag11_g62137 = Gradient_Tint2784_g61919;
				o.ase_texcoord4.x = vertexToFrag11_g62137;
				float3 temp_cast_8 = (_NoiseScaleValue).xxx;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				float temp_output_7_0_g62120 = _NoiseMinValue;
				half Noise_Tint2802_g61919 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_8 * WorldPosition3905_g61919 * 0.1 ), 0.0) ).r - temp_output_7_0_g62120 ) / ( _NoiseMaxValue - temp_output_7_0_g62120 ) ) );
				float vertexToFrag11_g62143 = Noise_Tint2802_g61919;
				o.ase_texcoord4.y = vertexToFrag11_g62143;
				float2 vertexToFrag11_g62084 = ( ( v.texcoord0.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord4.zw = vertexToFrag11_g62084;
				o.ase_texcoord5.xyz = vertexToFrag3890_g61919;
				
				float2 vertexToFrag11_g62119 = ( ( v.texcoord0.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord6.xy = vertexToFrag11_g62119;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float vertexToFrag11_g62137 = IN.ase_texcoord4.x;
				float3 lerpResult2779_g61919 = lerp( (_GradientColorTwo).rgb , (_GradientColorOne).rgb , vertexToFrag11_g62137);
				float vertexToFrag11_g62143 = IN.ase_texcoord4.y;
				float3 lerpResult2800_g61919 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g62143);
				half Leaves_Mask4511_g61919 = 1.0;
				float3 lerpResult4521_g61919 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g61919 * lerpResult2800_g61919 * float3(1,1,1) ) , Leaves_Mask4511_g61919);
				float3 lerpResult4519_g61919 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g61919);
				float2 vertexToFrag11_g62084 = IN.ase_texcoord4.zw;
				half2 Main_UVs15_g61919 = vertexToFrag11_g62084;
				float4 tex2DNode29_g61919 = tex2D( _MainAlbedoTex, Main_UVs15_g61919 );
				half3 Main_Albedo99_g61919 = ( lerpResult4519_g61919 * (tex2DNode29_g61919).rgb );
				half3 Blend_Albedo265_g61919 = Main_Albedo99_g61919;
				...
				float3 temp_cast_0 = (dotResult3616_g61919).xxx;
				float4 temp_output_91_19_g62122 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g61919 = IN.ase_texcoord5.xyz;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				float3 Position58_g62122 = WorldPosition3905_g61919;
				float temp_output_82_0_g62122 = _LayerColorsValue;
				float4 lerpResult88_g62122 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (temp_output_91_19_g62122).zw + ( (temp_output_91_19_g62122).xy * (Position58_g62122).xz ) ),temp_output_82_0_g62122 ) , TVE_ColorsUsage[(int)temp_output_82_0_g62122]);
				...
				float4 temp_output_4214_0_g61919 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g62119 = IN.ase_texcoord6.xy;
				half2 Emissive_UVs2468_g61919 = vertexToFrag11_g62119;
				half Global_Extras_Emissive4203_g61919 = break89_g62109.r;
				float lerpResult4206_g61919 = lerp( 1.0 , Global_Extras_Emissive4203_g61919 , _GlobalEmissive);
				half3 Final_Emissive2476_g61919 = ( (( temp_output_4214_0_g61919 * tex2D( _EmissiveTex, Emissive_UVs2468_g61919 ) )).rgb * lerpResult4206_g61919 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord3.xyz = vertexToFrag3890_g61919;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_cast_0 = (dotResult3616_g61919).xxx;
				float4 temp_output_91_19_g62122 = TVE_ColorsCoords;
				float3 vertexToFrag3890_g61919 = IN.ase_texcoord3.xyz;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				float3 Position58_g62122 = WorldPosition3905_g61919;
				float temp_output_82_0_g62122 = _LayerColorsValue;
				float4 lerpResult88_g62122 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (temp_output_91_19_g62122).zw + ( (temp_output_91_19_g62122).xy * (Position58_g62122).xz ) ),temp_output_82_0_g62122 ) , TVE_ColorsUsage[(int)temp_output_82_0_g62122]);
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 vertexToFrag11_g62084 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord4.xy = vertexToFrag11_g62084;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_TARGET
			{
				...
				float2 vertexToFrag11_g62084 = IN.ase_texcoord4.xy;
				half2 Main_UVs15_g61919 = vertexToFrag11_g62084;
				float3 unpack4112_g61919 = UnpackNormalScale( tex2D( _MainNormalTex, Main_UVs15_g61919 ), _MainNormalValue );
				unpack4112_g61919.z = lerp( 1, unpack4112_g61919.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g61919 = unpack4112_g61919;
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				o.ase_texcoord1.xyz = vertexToFrag3890_g61919;
				float2 vertexToFrag11_g62084 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 normalizeResult2169_g61919 = normalize( ase_worldViewDir );
				float3 ViewDir_Normalized3963_g61919 = normalizeResult2169_g61919;
				float3 normalizeResult3971_g61919 = normalize( cross( ddy( ase_worldPos ) , ddx( ase_worldPos ) ) );
				float3 NormalsWS_Derivates3972_g61919 = normalizeResult3971_g61919;
				float dotResult2161_g61919 = dot( ViewDir_Normalized3963_g61919 , NormalsWS_Derivates3972_g61919 );
				float dotResult2212_g61919 = dot( ViewDir_Normalized3963_g61919 , float3(0,1,0) );
				half Mask_HView2656_g61919 = dotResult2212_g61919;
				...
				half Fade_Billboard2175_g61919 = lerpResult3992_g61919;
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Billboard2175_g61919 );
				float3 vertexToFrag3890_g61919 = IN.ase_texcoord1.xyz;
				float3 WorldPosition3905_g61919 = vertexToFrag3890_g61919;
				half Final_AlphaFade3727_g61919 = saturate( ( temp_output_41_0_g62144 + ( temp_output_41_0_g62144 * tex3D( TVE_ScreenTex3D, ( TVE_ScreenTexCoord * WorldPosition3905_g61919 ) ).r ) ) );
				...
				surfaceDescription.Alpha = Final_Clip914_g61919;
...
Node;AmplifyShaderEditor.FunctionNode;398;-1536,-896;Inherit;False;Compile Core;-1;;62152;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;397;-1344,-896;Inherit;False;Compile All Shaders;-1;;61917;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E131E6FA8D9A96334C0675B746C0E63398F6264C
