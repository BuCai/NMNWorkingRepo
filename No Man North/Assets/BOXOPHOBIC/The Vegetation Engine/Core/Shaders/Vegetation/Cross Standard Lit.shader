	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 Vertex_Motion_Object833_g55655 = ( VertexPosRotationAxis50_g62104 + ( VertexPosOtherAxis82_g62104 * cos( Angle44_g62104 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g62104 ) * sin( Angle44_g62104 ) ) );
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				...
				float temp_output_41_0_g62144 = ( 1.0 * Fade_Billboard2175_g55655 );
...
Node;AmplifyShaderEditor.FunctionNode;313;-1344,-896;Inherit;False;Compile All Shaders;-1;;62152;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;314;-1536,-896;Inherit;False;Compile Core;-1;;62153;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=B28A097CA077E61E66E58AE53FF54B46BB229159
