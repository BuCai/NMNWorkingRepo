	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 Mesh_PivotsData2831_g55655 = ( appendResult60_g62103 * _VertexPivotMode );
				...
				float3 vertexToFrag4224_g55655 = temp_output_114_0_g62076;
				...
				float3 Vertex_Motion_Object833_g55655 = ( ( VertexPosRotationAxis50_g62104 + ( VertexPosOtherAxis82_g62104 * cos( Angle44_g62104 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g62104 ) * sin( Angle44_g62104 ) ) ) + Motion_30_Details263_g55655 );
				...
				float temp_output_335_0_g55655 = saturate( ( ( ( distance( _WorldSpaceCameraPos , ObjectPosition4223_g55655 ) * ( 1.0 / TVE_DistanceFadeBias ) ) - temp_output_7_0_g62100 ) / ( _SizeFadeStartValue - temp_output_7_0_g62100 ) ) );
				...
				half3 ObjectData20_g62097 = lerpResult3556_g55655;
				...
				#endif
				float3 Vertex_SizeFade1740_g55655 = staticSwitch14_g62097;
				...
				half Noise_Tint2802_g55655 = saturate( ( ( tex3Dlod( TVE_WorldTex3D, float4( ( temp_cast_12 * WorldPosition3905_g55655 * 0.1 ), 0.0) ).r - temp_output_7_0_g62120 ) / ( _NoiseMaxValue - temp_output_7_0_g62120 ) ) );
				float vertexToFrag11_g62143 = Noise_Tint2802_g55655;
				o.ase_texcoord8.y = vertexToFrag11_g62143;
				half2 Global_MotionDirectionWS4683_g55655 = (temp_output_398_0_g62099).xz;
				...
				float vertexToFrag11_g62095 = Highlight_Tint3231_g55655;
				o.ase_texcoord8.z = vertexToFrag11_g62095;
				float2 vertexToFrag11_g62084 = ( ( v.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord9.xy = vertexToFrag11_g62084;
				...
				o.ase_texcoord9.zw = vertexToFrag11_g62119;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float vertexToFrag11_g62095 = IN.ase_texcoord8.z;
				half Leaves_Mask4511_g55655 = 1.0;
				float3 lerpResult4521_g55655 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g55655 * lerpResult2800_g55655 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g62095 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g55655);
				float3 lerpResult4519_g55655 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g55655);
				float2 vertexToFrag11_g62084 = IN.ase_texcoord9.xy;
				...
				half Global_Colors_Mask3692_g55655 = saturate( ( ( ( 1.0 - IN.ase_color.a ) - temp_output_7_0_g62131 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g62131 ) ) );
				...
				half Subsurface_Mask1557_g55655 = saturate( ( ( IN.ase_color.a - temp_output_7_0_g62148 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g62148 ) ) );
				...
				half Overlay_Mask269_g55655 = saturate( ( ( ( ( ( IN.ase_color.a * 0.5 ) + Main_AlbedoTex_G3526_g55655 ) * Overlay_Commons1365_g55655 ) - temp_output_7_0_g62145 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g62145 ) ) );
				...
				float3 lerpResult2945_g55655 = lerp( (_VertexOcclusionColor).rgb , temp_cast_6 , vertexToFrag11_g62138);
				...
				float2 vertexToFrag11_g62119 = IN.ase_texcoord9.zw;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 VertexPosition3588_g55655 = v.vertex.xyz;
				float3 appendResult60_g62103 = (float3(v.texcoord0.z , 0.0 , v.texcoord0.w));
				half3 Mesh_PivotsData2831_g55655 = ( appendResult60_g62103 * _VertexPivotMode );
				half3 Mesh_PivotsOS2291_g55655 = Mesh_PivotsData2831_g55655;
				float3 temp_output_2283_0_g55655 = ( VertexPosition3588_g55655 - Mesh_PivotsOS2291_g55655 );
				half3 VertexPos40_g62096 = temp_output_2283_0_g55655;
				...
				float4x4 break19_g62076 = GetObjectToWorldMatrix();
				float3 appendResult20_g62076 = (float3(break19_g62076[ 0 ][ 3 ] , break19_g62076[ 1 ][ 3 ] , break19_g62076[ 2 ][ 3 ]));
				float3 appendResult60_g62078 = (float3(v.texcoord0.z , 0.0 , v.texcoord0.w));
				float3 temp_output_91_0_g62076 = ( appendResult60_g62078 * _vertex_pivot_mode );
				float3 PivotsOnly105_g62076 = (mul( GetObjectToWorldMatrix(), float4( temp_output_91_0_g62076 , 0.0 ) ).xyz).xyz;
				half3 ObjectData20_g62077 = ( appendResult20_g62076 + PivotsOnly105_g62076 );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				...
				half Highlight_Tint3231_g55655 = ( max( break4748_g55655.x , break4748_g55655.y ) * saturate( ( Motion_10_Bending2258_g55655 * Motion_10_Bending2258_g55655 ) ) * Wind_FadeOut4005_g55655 * Mesh_Height1524_g55655 );
				float vertexToFrag11_g62095 = Highlight_Tint3231_g55655;
				o.ase_texcoord4.z = vertexToFrag11_g62095;
				float2 vertexToFrag11_g62084 = ( ( v.texcoord0.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord5.xy = vertexToFrag11_g62084;
				...
				o.ase_texcoord5.zw = vertexToFrag11_g62119;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 lerpResult2800_g55655 = lerp( (_NoiseColorTwo).rgb , (_NoiseColorOne).rgb , vertexToFrag11_g62143);
				float vertexToFrag11_g62095 = IN.ase_texcoord4.z;
				half Leaves_Mask4511_g55655 = 1.0;
				float3 lerpResult4521_g55655 = lerp( float3( 1,1,1 ) , ( lerpResult2779_g55655 * lerpResult2800_g55655 * ( ( (_MotionHighlightColor).rgb * vertexToFrag11_g62095 ) + float3( 1,1,1 ) ) ) , Leaves_Mask4511_g55655);
				float3 lerpResult4519_g55655 = lerp( float3( 1,1,1 ) , (_MainColor).rgb , Leaves_Mask4511_g55655);
				float2 vertexToFrag11_g62084 = IN.ase_texcoord5.xy;
				half2 Main_UVs15_g55655 = vertexToFrag11_g62084;
				float4 tex2DNode29_g55655 = tex2D( _MainAlbedoTex, Main_UVs15_g55655 );
				half3 Main_Albedo99_g55655 = ( lerpResult4519_g55655 * (tex2DNode29_g55655).rgb );
				half3 Blend_Albedo265_g55655 = Main_Albedo99_g55655;
				...
				float4 temp_output_4214_0_g55655 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				float2 vertexToFrag11_g62119 = IN.ase_texcoord5.zw;
				half2 Emissive_UVs2468_g55655 = vertexToFrag11_g62119;
				half Global_Extras_Emissive4203_g55655 = break89_g62109.r;
				float lerpResult4206_g55655 = lerp( 1.0 , Global_Extras_Emissive4203_g55655 , _GlobalEmissive);
				half3 Final_Emissive2476_g55655 = ( (( temp_output_4214_0_g55655 * tex2D( _EmissiveTex, Emissive_UVs2468_g55655 ) )).rgb * lerpResult4206_g55655 );
        ...
        Pass
        {
			...
			VertexOutput VertexFunction(VertexInput v  )
			{
				...
				float2 vertexToFrag11_g62084 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord.xy = vertexToFrag11_g62084;
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float localCustomAlphaClip3735_g55655 = ( 0.0 );
				half Final_AlphaFade3727_g55655 = 1.0;
				float2 vertexToFrag11_g62084 = IN.ase_texcoord.xy;
				half2 Main_UVs15_g55655 = vertexToFrag11_g62084;
				float4 tex2DNode29_g55655 = tex2D( _MainAlbedoTex, Main_UVs15_g55655 );
				float Main_Alpha316_g55655 = ( _MainColor.a * tex2DNode29_g55655.a );
				float Mesh_Variation16_g55655 = IN.ase_color.r;
...
Node;AmplifyShaderEditor.FunctionNode;597;-1536,-896;Inherit;False;Compile Core;-1;;62152;634b02fd1f32e6a4c875d8fc2c450956;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;535;-2176,384;Inherit;False;Define Shader Grass;-1;;62153;921559c53826c0142ba6e27dd03eaef2;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FD5BC33365B2048815A81E1FABC99B820CE08CAB
