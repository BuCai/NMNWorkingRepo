...
namespace WorldStreamer2 {
    ...
    public class TerrainCullingSystem : MonoBehaviour {
        //Global value to enable or disable terrain culling
        public readonly static bool GlobalEnabled = false;
        ...
        public void Update() {
            ...
            if (Camera.main == null) {
                Debug.LogWarning("Terrain culling paused, main camera is null");
                return;
            }
